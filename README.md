...
- 1 x single-digit 7-segment display (common cathode)- 1 x 220 ohm resistor (on the COM pin)
...
- 2D arrays for digit patterns (lookup table)- Functions with parameters
- while and for loops
